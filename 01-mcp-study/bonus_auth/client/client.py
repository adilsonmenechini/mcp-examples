...
server_params = StdioServerParameters(
    ...
    args=["run", "python", "tools/print.py"],  # Argumentos para executar o script do servidor
    env={"username": "testuser", "password": "secure_password"}  # Token de autenticação passado como variável de ambiente
)
